# Discord Stat Bot
# Komutlar
* `me`: Komutu kullanan kişinin istatistiklerini gösterir.
* `top`: Sunucunun toplam istatistiklerini gösterir.
* `role`: Belirttiğiniz rolün toplam istatistiklerini gösterir.
* `user`: Belirttiğiniz kişinin istatistiklerini gösterir.
...
# İletişim
* [Discord Sunucum](https://discord.gg/darkparadise)
* [Discord Profilim](https://discord.com/users/974095294897717258)
